"""Tile propagation for StereoLite_yolo_ctx.

Carries forward the cost-lookup-driven ConvGRU update from `raftlike` and
adds a dedicated context stream:
...
class TileRefineCtx(nn.Module):
    """Cost-lookup-driven ConvGRU TileRefine with a dedicated context stream.
    ...
    The GRU update is the standard minimal ConvGRU (z, r, q gates).
    """

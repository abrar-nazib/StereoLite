"""StereoLite_yolo_ctx — YOLO26 matching encoder + dedicated context encoder.
...
class StereoLiteYoloCtx(nn.Module):
    def __init__(self, cfg: StereoLiteYoloCtxConfig | None = None):
        super().__init__()
        self.cfg = cfg or StereoLiteYoloCtxConfig()

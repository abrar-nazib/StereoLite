...
Outputs:
    model/designs/d1_tile/training_curves.pdf       (4-panel loss/LR curves)
    model/designs/d1_tile/progress_grid.pdf         (same 2 pairs × 5 steps)
    model/designs/d1_tile/final_gallery.pdf         (all 6 val pairs at final step)
"""
...
OUT = os.path.join(ROOT, "model", "designs", "d1_tile")

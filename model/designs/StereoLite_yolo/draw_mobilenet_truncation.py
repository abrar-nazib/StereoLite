...
Run:
    python3 model/designs/StereoLite/draw_mobilenet_truncation.py
Output:
    model/designs/StereoLite/mobilenet_truncation.png
    model/designs/StereoLite/mobilenet_truncation.pdf
"""
